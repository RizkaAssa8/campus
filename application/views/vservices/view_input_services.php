    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card card-primary">
          ...
          <form class="form-horizontal" action="<?php echo base_url(). 'services_c/add_services_action'; ?>" method="post">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaUser3" placeholder="Ex : Setrika" name="name_srvc" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaUser3" placeholder="Ex : 100000000" name="price_perkg" required>
                  </div>
                </div>          
              </div>
