    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo base_url().'services_c' ?>" class="nav-link active">
    ...
    <section class="content">
      ...
      <div class="col-12">
        ...
        <div class="box">
          ...
          <?php 
          $no = 1;
          foreach($service_categories as $u){ 
          ?>

          <tr>
            <td><?php echo $no++ ?></td>
            <td><?php echo $u->id_srvc ?></td>
            <td><?php echo $u->name_srvc ?></td>
            <td><?php echo $u->price_perkg ?></td>
            <td>
                  <a class="btn btn-success" href="<?php echo base_url('services_c/edit_services/'.$u->id_srvc)?>">Edit</a>

                  <a class="btn btn-info" href="<?php echo base_url('services_c/detail_services/'.$u->id_srvc)?>">Detail</a>

                  <a class="btn btn-danger" href="<?php echo base_url('services_c/delete_services/'.$u->id_srvc)?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
