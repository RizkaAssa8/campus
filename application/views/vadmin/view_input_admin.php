    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="card card-primary">
          ...
          <form class="form-horizontal" action="<?php echo base_url(). 'admin_c/add_admin_action'; ?>" method="post">
              <?php echo validation_errors(); ?>
              <div class="card-body">

                <div class="form-group">
                  <label for="inputNamaUser3" class="col-sm-2 control-label">Name of Admin</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNamaUser3" placeholder="Ex : Caca" name="username" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="password" class="form-control" id="inputNamaUser3" placeholder="Ex : 100000000" name="password" required>
                  </div>
                </div>          
              </div>
