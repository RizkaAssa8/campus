      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="<?=base_url()?>admin_c/add_admin" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i>Add</a>      
      ...
      <div class="col-12">
        ...
        <div class="box">
          ...
          <tr>
            ...
            <td>
                  <a class="btn btn-success" href="<?php echo base_url('admin_c/edit_admin/'.$u->id_admin)?>">Edit</a>

                  <a class="btn btn-info" href="<?php echo base_url('admin_c/detail_admin/'.$u->id_admin)?>">Detail</a>

                  <a class="btn btn-danger" href="<?php echo base_url('admin_c/delete_admin/'.$u->id_admin)?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
