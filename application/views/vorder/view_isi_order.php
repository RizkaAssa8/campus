      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="<?=base_url()?>order_c/add_order" class="btn btn-sm btn-primary"><i class="glyphicon glyphicon-plus"></i>    Add</a>      
      ...
      <div class="col-12">
        ...
        <div class="box">
          ...
          <tr>
            ...
            <td><?php echo $u->name_srvc ?></td>
            <td><?php echo $u->date_srvc ?></td>
            <td><?php echo $u->name_ordstatus ?></td>

            <td>
                  <a class="btn btn-success" href="<?php echo base_url('order_c/edit_order/'.$u->id_order)?>">Edit</a>

                  <a class="btn btn-info" href="<?php echo base_url('order_c/detail_order/'.$u->id_order)?>">Detail</a>

                  <a class="btn btn-danger" href="<?php echo base_url('order_c/delete_order/'.$u->id_order)?>" onclick="return confirm('Are you sure to delete this?');">Delete</a>
